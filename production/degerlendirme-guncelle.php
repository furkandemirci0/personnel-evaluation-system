...
$ayarsor=$db->prepare("select * from degerlendirme where DegID=$id");
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> <small>Değerlendirme Güncelleme</small></h2>
                    ...
                    <select class="select2_multiple form-control" required="" name="CalisanID" >
                     ...
                     while($calisancek=$calisansor->fetch(PDO::FETCH_ASSOC)) {
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="departman-name" required="required" class="form-control col-md-7 col-xs-12" name="Soru" value=" <?php echo $ayarcek['Soru'] ?> ">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="departman-name" required="required" class="form-control col-md-7 col-xs-12" name="Cevap" value=" <?php echo $ayarcek['Cevap'] ?> ">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" min="1" max="100" id="departman-name" required="required" class="form-control col-md-7 col-xs-12" name="Puan" value=" <?php echo $ayarcek['Puan'] ?> ">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                           <input type="hidden" name="DegID" value="<?php echo $id ?>">
                          <button type="submit" name="degerlendirmeguncelle" class="btn btn-success">Güncelle</button>
                        </div>
                      </div>
                    </form>
                  </div>
