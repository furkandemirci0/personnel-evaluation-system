...
$ayarsor=$db->prepare("SELECT yonetici.KimlikNo, yonetici.Ad, yonetici.Soyad, yonetici.Eposta, yonetici.Telefon, yonetici.Unvan, departman.DepartmanAd, yonetici.DepartmanID
FROM yonetici
INNER JOIN departman
ON yonetici.DepartmanID = departman.DepartmanID where YoneticiID=$id");
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> <small>Yönetici Güncelleme</small></h2>
                    ...
                    <form id="demo-form2" action="islem.php" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="KimlikNo" value=" <?php echo $ayarcek['KimlikNo'] ?> ">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="Telefon" value=" <?php echo $ayarcek['Telefon'] ?> ">
                        </div>
                      </div>
                      <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <?php  
                   ...
                   $YoneticiDepartmanID=$ayarcek['DepartmanID']; // çalışanın departmanid
                  ...
                  $departmansor->execute(array(
                    ...
                    <select class="select2_multiple form-control" required="" name="DepartmanID" >
                     ...
                     while($departmancek=$departmansor->fetch(PDO::FETCH_ASSOC)) {
                       ...
                       <option <?php if ($YoneticiDepartmanID==$DepartmanID) { echo "selected='select'"; } ?> value="<?php echo $departmancek['DepartmanID']; ?>"><?php echo $departmancek['DepartmanAd']; ?></option>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <input type="hidden" name="YoneticiID" value="<?php echo $id ?>">
